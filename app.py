...
model = pickle.load(open("D://Anti Fraud Credit Card System//model.pkl", "rb"))
app = Flask(__name__)
...
def predictor():
    model = pickle.load(open("D://Anti Fraud Credit Card System//model1.pkl", "rb"))
...
app.config["UPLOAD_FOLDER"] = "D://Anti Fraud Credit Card System//uploads"
...
def home():
    ...
    if form.validate_on_submit():
        ...
        model_path = "D://Anti Fraud Credit Card System//model1.pkl"
