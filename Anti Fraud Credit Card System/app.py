...
model = pickle.load(open("E://CreditCardFraud//templates//model.pkl", "rb"))
app = Flask(__name__)
...
def predictor():
    model = pickle.load(open("E://TRANSACTION_FRAUD//templates//model.pkl", "rb"))
...
app.config["UPLOAD_FOLDER"] = "D://Creditcard_Attr//uploads"
...
def home():
    ...
    if form.validate_on_submit():
        ...
        model_path = "E://CreditCardFraud//templates//model.pkl"
